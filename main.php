    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="basicExampleNav">
            ...
            <ul class="navbar-nav mr-auto smooth-scroll">
                <li class="nav-item">
                    <a class="nav-link text-white" href="#nav">Home</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link text-white" href="#cs">Detail</a>
                </li>
                <li class="nav-item">
...
<section class="my-5">
  ...
  <!-- Section heading -->
  <h2 class="h1-responsive text-white font-weight-bold text-center my-5">ผลงาน</h2>
  <!-- Section description -->
