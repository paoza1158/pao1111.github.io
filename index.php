...
<head>
    ...
    <title>RESUME Jirateep tobua</title>
    <!-- Font Awesome -->
...
<body id="bod">
 <!-- Links -->
<!--Navbar-->
<nav class="navbar navbar-expand-lg navbar-black font-weight-bold fixed-top scrolling-navbar" id="nav">
    <div class="container">
        <!-- Navbar brand -->
        <a class="navbar-brand text-white" id="res">RESUME</a>

        <div class="collapse navbar-collapse" id="basicExampleNav">
            <!-- Links -->
            <ul class="navbar-nav mr-auto smooth-scroll">
                <li class="nav-item">
                    <a class="nav-link text-white" href="#bod">Home</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link text-white" href="#resume">Detail</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link text-white" href="#tow">Work</a>
                </li>
            </ul>         
        </div>
        <!-- Collapsible content -->
...
<img src="RESUME_Jirateep.jpg"  class="wow fadeIn z-depth-5" id="resume" >
</div>

<!-- Section: Blog v.1 -->
<div class="phot" id="tow">
<section class="my-5 ">

  <!-- Section heading -->
  <h2 class="h1-responsive text-white font-weight-bold text-center my-5">ผลงาน</h2><br><br><br>
  <!-- Section description -->
  ...
  <div class="row">
    ...
    <div class="col-lg-5">
      ...
      <!-- Featured image -->
      <div class="wow slideInLeft view overlay rounded z-depth-2 mb-lg-0 mb-4">
  ...
  <div class="row">
    ...
    <div class="col-lg-5">
      ...
      <!-- Featured image -->
      <div class="wow slideInRight view overlay rounded z-depth-2">
...
<footer class="page-footer color-dark pt-4">
    <!-- Copyright -->
    <div class="footer-copyright text-center py-3">Contact:  
     <i class="fa fa-phone" aria-hidden="true"></i>  0885970060 &nbsp;&nbsp;&nbsp;
      <i class="fa fa-envelope" aria-hidden="true"></i> jirateeptobua@gmail.com
...
>>>>>>> 33930ac976bebc371da48be5491a405cf09123af
</html>